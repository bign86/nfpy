...
class ResultReportOptimization(AttributizedDict):
...
class ReportPtfOptimization(BaseReport):
    ...
    def _run(self):
        ...
        # Run optimizers
        oe = OptimizationEngine(self._uid, **kwargs)
        model_res = oe.result
    ...
    def _create_output(self, model_res: ResultOptimization, wgt: np.ndarray):
        """ Create the final output.
            ...
            Output:
                res [ResultReportPtfOptimization]: result of the optmization
        """
        # Generate plot paths
        uid = self._uid
        ...
        # Create plot
        div_pl = PlotPortfolioOptimization(y_zero=.0)
